...
public class Stats {
    ...
    public final static Pair<NamespacedKey, PersistentDataType> DEFENSE = new Pair<>(Util.getNamespacedKey("Defense"), PersistentDataType.INTEGER);
    public final static Pair<NamespacedKey, PersistentDataType> STRENGTH = new Pair<>(Util.getNamespacedKey("Strength"), PersistentDataType.INTEGER);
    public final static Pair<NamespacedKey, PersistentDataType> DEXTERITY = new Pair<>(Util.getNamespacedKey("Dexterity"), PersistentDataType.INTEGER);
    ...
    public final static Pair<NamespacedKey, PersistentDataType> CRITDAMAGE = new Pair<>(Util.getNamespacedKey("CritDamage"), PersistentDataType.INTEGER);
